c!!!!!!!!!!!!!!!!! IT can Not work now, Please modifty it if needed!!!!!!!!!!!!!!!!!!!!!!!
c	Calculate Evaporation from open water
c	The method from Doorenbos and Pruitt in FAO's Irrigation and Drainage Paper 24 (1977)
c	The meaning of parameters refers to (just refers to)
c	URL:http://www.fao.org/docrep/X0490E/x0490e00.htm#Contents
c	Comments (E21) means Equation 21 in the reference
c	If ID =1 assume G = 0.0 (even for hourly, G =0.0 is not right)
c	Else G will be gotten from input
	subroutine PMON_water_day(Lat,Alt,DJ,DN,G,
	...
	PRINT *, "SORRY, SUBROUTINE PMON_water_day CAN NOT WORK NOW!"
	STOP
