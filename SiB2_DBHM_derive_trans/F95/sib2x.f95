...
!                                                                        
      if (itero.eq.1) then                             ! write labels 
         ...
         'LE_C','G_C','J_C','Fc_C','Rsc_C','An_C','ustar_C','u2_C',       &
     ...
     & rvar(34), rvar(65), rvar(33),rvar(66), rvar(69),&! Fc,Rsc,An,u*,u2   
...
!                                                                        
      ...
      !print *, rhoair
      !print *, g1, z2, z1, chil, vcover, ra, rb, rd, u2, cpair, ztz0,'   <<<<-------------------ANTES' ! entradas via comsibc
